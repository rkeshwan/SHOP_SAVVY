...
ActiveRecord::Schema[7.0].define(version: 2024_02_17_035823) do
  ...
  create_table "grocery_lists", force: :cascade do |t|
    ...
    t.index ["line_item_id"], name: "index_grocery_lists_on_line_item_id"
  ...
  add_foreign_key "grocery_lists", "line_items"
